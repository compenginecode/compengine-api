...
namespace IntegrationTests\PresentationLayer\Routes\Categories\Browse\Get;

use Guzzle\Http\Client;

/**
 * Class GetTest
 * @package IntegrationTests\PresentationLayer\Routes\Categories\Browse\Get
 */
class GetTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_browsing_categories($expectedStatusCode = 200, $expectedErrorMessage = null) {
        ...
        $request = $client->get("/categories/browse");
        ...
        if (null !== $expectedErrorMessage) {
            ...
            $this->assertArrayHasKey("categories", $responseBody);
