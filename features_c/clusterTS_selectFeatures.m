...
%             'CO_FirstMin_ac', ... % 'DN_OutlierInclude_abs_001.mdrmd', ...
%             'CO_trev_1.num', ...
%             'FC_LocalSimple_lfit.taures' , ... % 'SY_SpreadRandomLocal_50_100.meantaul', ...
...
for fileInd = 1:numel(filenames)
    ...
    featureMat = [featureMat, C{1}(ismember(C{2}, featureNameSelection))];
