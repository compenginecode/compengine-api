...
double quantile(double y[], int size, double quant)
{   
...
void binarize(double a[], int size, int b[], char how[])
{   
    double m = 0.0;
...
double f_entropy(double a[], int size)
{
    double f = 0.0;
    for (int i = 0; i < size; i++) {
        if (a[i] > 0) {
...
void subset(int a[], int b[], int start, int end)
{
    int j = 0;
